...
function crearGato(nombre, edad) {
   ...
   // La propiedad "meow" será una función que retorne el string:  meow:"Meow!" .
   // Retornar el objeto.
   // Tu código:
 var nuevoObj= {nombre:nombre, edad:edad, meow:function() {
   return "Meow!";}
 }
 return nuevoObj;
}
// gato = { nombre, edad, meow: () => {
//   return "Meow!"}
//} return gato;
...
} // return objetoUsuario.hasOwnProperty('email') no funciona xq solo da true y falta el objeto vacio.
...
//aca si funciona return objeto.hasOwnProperty(propiedad) ;
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   for (var i=0; i < objetoUsuario.posts.length ; i++) {
      likestotales = likestotales + objetoUsuario.posts[i].likes
   }
 return likestotales
   }
